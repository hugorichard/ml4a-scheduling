...
for i in range(6):
    for j in range(n_lambda):
        ...
        flow_times_low[i,j] = flow_times[i,j] -2*deviation[i,j]/flow_times[-1,j]
        flow_times_high[i,j] = flow_times[i,j] +2*deviation[i,j]/flow_times[-1,j]
...
plt.legend()
plt.savefig("../figures/n_50_vary_lambdas_logscale_test.pdf", bbox_inches="tight")
plt.savefig("../figures/n_50_vary_lambdas_logscale_test.png", bbox_inches="tight")
