...
all_flow_times = np.load("../experiments/data/etc_vs_opt-2-jobs-uniform-rebuttal.npy")
...
plt.legend()
plt.savefig("../figures/etc-vs-opt-2-jobs-uniform-rebuttal.pdf", bbox_inches="tight")
plt.savefig("../figures/etc-vs-opt-2-jobs-uniform-rebuttal.png", bbox_inches="tight")
