...
results = np.load("../experiments/data/etc_vs_opt-k-jobs-uniform-rebuttal.npy")
...
indices = {}
for i, algo in enumerate(["ETC-U", "ETC-RR", "FTPP", "RR", "LSEPT"]):
    indices[algo] = i

plt.figure()
for ii, algo in enumerate(["ETC-U", "ETC-RR", "RR", "FTPP", "LSEPT"]):
    i = indices[algo]
...
plt.legend()
plt.savefig("../figures/etc-vs-opt-k-jobs-uniform-rebuttal.pdf", bbox_inches="tight")
plt.savefig("../figures/etc-vs-opt-k-jobs-uniform-rebuttal.png", bbox_inches="tight")
